...
namespace Tests
{
	public class FileEntrySecretSyncTests
	{
		[SetUp]
		public void Setup()
		{
		...
		public void GetWithInvalidKeyTest()
		{
			...
			// Assert
			Assert.Throws<ArgumentNullException>(() => fes.GetFilename(null));
			Assert.Throws<ArgumentException>(() => fes.GetFilename(derivedKeyInvalid));
		}
