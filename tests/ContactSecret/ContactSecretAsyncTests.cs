...
namespace Tests
{
	public class ContactSecretAsyncTests
	{
		...
		public async Task GetSingleEntriesAsyncTest()
		{
			...
			CollectionAssert.AreEqual(emails, await cs.GetEmailsAsync(derivedKey, securityAsyncFunctions));
			CollectionAssert.AreEqual(emailDescriptions, await cs.GetEmailDescriptionsAsync(derivedKey, securityAsyncFunctions));
			CollectionAssert.AreEqual(phoneNumbers, await cs.GetPhoneNumbersAsync(derivedKey, securityAsyncFunctions));
			CollectionAssert.AreEqual(phoneNumberDescriptions, await cs.GetPhoneNumberDescriptionsAsync(derivedKey, securityAsyncFunctions));
